...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\mrish\PycharmProjects\pythonfacerecognition\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\mrish\PycharmProjects\pythonfacerecognition\venv\Scripts\deactivate.nu'
